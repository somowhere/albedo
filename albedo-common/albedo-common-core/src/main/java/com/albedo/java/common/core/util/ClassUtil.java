...
public class ClassUtil extends org.springframework.util.ClassUtils {
	...
	public static <T> Set<Class<? extends T>> getAllInterfaceAchieveClass(Class<T> type, String businessPackage) {

		Reflections reflections = new Reflections(businessPackage);
