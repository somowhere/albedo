...
public class AuditEventConverter {
	...
	/**
	 * Convert a list of {@link AuditEvent}s to a list of {@link AuditEvent}s.
	 *
	...
	/**
	 * Convert a {@link AuditEvent} to an {@link AuditEvent}.
	 *
	...
	public AuditEvent convertToAuditEvent(PersistentAuditEvent persistentAuditEvent) {
		...
		return new AuditEvent(
			Instant.ofEpochMilli(persistentAuditEvent.getAuditEventDate().getTime()),
