 ...
 */
@Log4j2
public class ExtraFieldDictSerializer extends BeanSerializerBase {

	Map<String, List<SelectVo>> codeItemData = Maps.newHashMap();

	public ExtraFieldDictSerializer(BeanSerializerBase source) {
		super(source);
	}

	public ExtraFieldDictSerializer(ExtraFieldDictSerializer source, ObjectIdWriter objectIdWriter) {
		super(source, objectIdWriter);
	}

	public ExtraFieldDictSerializer(ExtraFieldDictSerializer source, Set<String> toIgnore, Set<String> var2) {
		super(source, toIgnore, var2);
	}

	public ExtraFieldDictSerializer(ExtraFieldDictSerializer source, ObjectIdWriter objectIdWriter, Object filterId) {
		super(source, objectIdWriter, filterId);
	}

	@Override
	public BeanSerializerBase withObjectIdWriter(ObjectIdWriter objectIdWriter) {
		return new ExtraFieldDictSerializer(this, objectIdWriter);
	}

	@Override
	protected BeanSerializerBase withByNameInclusion(Set<String> toIgnore, Set<String> set1) {
		return new ExtraFieldDictSerializer(this, toIgnore, set1);
	}
	...
	public BeanSerializerBase withFilterId(Object filterId) {
		return new ExtraFieldDictSerializer(this, this._objectIdWriter, filterId);
	}
