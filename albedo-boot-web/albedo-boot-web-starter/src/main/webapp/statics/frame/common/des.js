 ...
 * @see DESCore
 */
var firstKey = "%E6%9D%B0", secondKey = "E7%88%B1", thirdKey = "%E7%B2%BE";
...
function getRequestKey() {
    ...
    var testStr = testDate.format("MMddhhmmss");
    var key = strEnc(testStr);
    return key;
}

/**
 * 加密encrypt the string to string made up of hex return the encrypted string
 */
...
/**
 * 解密 decrypt the encrypted string to the original string
 *
