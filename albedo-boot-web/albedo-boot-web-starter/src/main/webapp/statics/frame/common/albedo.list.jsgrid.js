...
albedo.searchItemForm = function(grid_selector, formId){
	var grid_selector = grid_selector ? grid_selector : "#grid-table",_search = $(grid_selector).jqGrid('getGridParam', "postData");
...
albedo.searchJsonItemForm = function(grid_selector, formId){
	var i=0,json_list=[],grid_selector = grid_selector ? grid_selector : "#grid-table",_search = $(grid_selector).jqGrid('getGridParam', "postData");
	var $target = formId ? $(formId).find("[searchItem='searchItem']") : $("[searchItem='searchItem']");
	$target.each(function(){
