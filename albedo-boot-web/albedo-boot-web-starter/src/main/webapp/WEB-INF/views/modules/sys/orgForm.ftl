<div class="modal-header">
    ...
    <h4 class="modal-title"><#if org.id??>添加<#else>编辑</#if>组织</h4>
</div>
            ...
            <form id="ajax_form" action="${ctx}/sys/org/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                        <@albedo.form name="status" cssClass="required" boxType="radio" dictCode="sys_status" value="${(org.status)! }"> </@albedo.form>
                        </div>
                    </div>
                    <div class="form-group">
