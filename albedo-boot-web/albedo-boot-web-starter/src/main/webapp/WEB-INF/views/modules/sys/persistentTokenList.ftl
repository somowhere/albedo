            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" role="form">
						<div class="form-group">
							...
							<input type="text" class="form-control" searchItem="searchItem" id="userLoginId" name="user.loginId" htmlEscape="false" maxlength="254" placeholder="...">
						</div>
						<div class="form-group">
					        <label class="input-label" for="ipAddress">ip</label>
							<input type="text" class="form-control" searchItem="searchItem" id="ipAddress" name="ipAddress" htmlEscape="false" maxlength="254" placeholder="...">
						</div>
                         <div class="form-group form-btn">
                         <button class="btn btn-sm green btn-outline filter-submit-table-persistentToken margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-persistentToken">
                        <thead>	 
