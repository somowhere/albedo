            ...
            <form id="ajax_form" action="${ctx}/sys/module/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="name" value="${(module.name)! }" maxlength="64" data-required="1"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="iconCls" value="${(module.iconCls)! }" maxlength="64"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="permission" value="${(module.permission)! }" maxlength="64"
                                   data-required="1" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="target" value="${(module.target)! }" maxlength="64"
                                   data-required="1" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="url" value="${(module.url)! }" maxlength="255" data-required="1"
                                   class="form-control "/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="sort" value="${(module.sort)! }" maxlength="10" data-required="1"
