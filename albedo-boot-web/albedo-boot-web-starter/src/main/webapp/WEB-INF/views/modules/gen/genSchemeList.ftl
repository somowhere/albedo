    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <#if SecurityUtil.hasPermission('sys_genScheme_edit')><a id="add_member" class="btn red dialog" href="javascript:void(0);" 
                        data-url="${ctx}/gen/genScheme/edit" data-modal-width="950" data-is-modal="" data-table-id="#data-table-genScheme">
            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" role="form">
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control" searchItem="searchItem" id="genTableName" name="genTableName" placeholder="..."> </div>
                       <div class="form-group">
                           <label class="input-label" for="functionName">功能名称 </label>
                           <input type="text" class="form-control" searchItem="searchItem" id="functionName" name="functionName" placeholder="..."> </div>
                       <div class="form-group">
                           <label class="input-label" for="name">功能作者 </label>
                           <input type="text" class="form-control" searchItem="searchItem" id="functionAuthor" name="functionAuthor" placeholder="..."> </div>
                      <div class="form-group">
                      ...
                      <div class="form-group form-btn">
                       <button class="btn btn-sm green btn-outline filter-submit-table-genScheme margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
          ...
          <div id="bootstrap-alerts"></div>
                <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-genScheme">
                    <thead>
