    ...
    <div class="col-md-10">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <#if SecurityUtil.hasPermission('sys_org_edit')><a id="add-org" class="btn red dialog" href="javascript:void(0);" 
                        data-url="${ctx}/sys/org/edit" data-modal-width="950" data-reload-after="refreshTreeOrg" data-is-modal="true" data-table-id="#data-table-org">
            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" org="form">
                    ...
                    <button class="btn btn-sm green btn-outline filter-submit-table-org margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
          ...
          <div id="bootstrap-alerts"></div>
                <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-org">
                    <thead>
                    <tr org="row" class="heading">
                        ...
                        <th width="10%"> 状态 </th>
                        <th width="10%"> 修改时间 </th>
                        <#if SecurityUtil.hasPermission('sys_org_edit,sys_org_lock,sys_org_delete')><th width="10%"> 操作 </th></#if>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            grid.init({
                ...
                dataTable: {
                    ...
                    "columns": [
                        ...
                        <#if SecurityUtil.hasPermission('sys_org_edit,sys_org_lock,sys_org_delete')>{ orderable: false, data: function ( row, type, val, meta ) {
                    		...
                    		<#if SecurityUtil.hasPermission('sys_org_delete')>+'<a href="javascript:void(0);" class="confirm" data-table-id="#data-table-org" data-method="delete" data-title="你确认要删除【'+row.name+'】机构吗？" data-url="${ctx}/sys/org/delete/'+row.id+'"><i class=\"fa fa-lg fa-trash-o font-red-mint\" title=\"删除\"></i></a>'</#if>+'</span>';
                            return data;
                        }}</#if>
                    ]
                }
