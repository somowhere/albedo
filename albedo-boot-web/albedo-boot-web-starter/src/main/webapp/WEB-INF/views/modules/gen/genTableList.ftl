    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        ...
                        data-url="${ctx}/gen/genTable/edit" data-modal-width="950" data-is-modal="" data-table-id="#data-table-genTable">
            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" role="form">
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control" searchItem="searchItem" id="comments" name="comments" placeholder="..."> </div>
                       <div class="form-group">
                           <label class="input-label" for="parentTable">父表名</label>
                           <input type="text" class="form-control" searchItem="searchItem" id="parentTable" name="parentTable" placeholder="..."> </div>
                       <div class="form-group">
                       ...
                       <button class="btn btn-sm green btn-outline filter-submit-table-genTable margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
          ...
          <div id="bootstrap-alerts"></div>
                <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-genTable">
                    <thead>
