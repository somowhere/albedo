		...
		<form id="ajax_form" action="${ctx}/sys/area/edit" method="post"
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control " id="name" name="name" value="${(area.name)!}" htmlEscape="false" maxlength="32" class="">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">区域简称</label>
					<div class="col-md-5">
						<input type="text" class="form-control " id="shortName" name="shortName" value="${(area.shortName)!}" htmlEscape="false" maxlength="32" class="">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">序号<span class="required">*</span></label>
					<div class="col-md-5">
						<input type="text" class="form-control required" id="sort" name="sort" value="${(area.sort)!}" htmlEscape="false" maxlength="11" class="required digits">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control " id="code" name="code" value="${(area.code)!}" htmlEscape="false" maxlength="32" class="">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">描述</label>
					<div class="col-md-5">
						<textarea class="form-control" name="description" rows="5" maxlength="225" class="input-xxlarge ">${(area.description)! }</textarea>
					</div>
				</div>
