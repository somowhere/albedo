			...
			<#list  SecurityUtil.getModuleList()! as moduleParent>
				<#if (moduleParent.parentId)! == '4d32c49cc7f448dcbfb92ce9c4dde058' > 
                	...
                	<li class='nav-item ${(module_index == 0)!?string("start", "")}'>
                        <a href="#${(module.hrefName)! }" data-url-name="${(module.hrefName)! }" data-url="${ctx }${(module.href)! }" class="nav-link pageModal" data-target="${(module.target)!}" >
                             ...
                             <#list moduleList as tempModule>
                             	<#if (module.show)! && (module.type)! == '1' && (tempModule.parentId)! == (module.id)! > 
                                     <li class="nav-item start">
                                         <a href="#${(tempModule.hrefName)! }" data-url-name="${(tempModule.hrefName)! }" data-url="${ctx }${(tempModule.href)! }" class="nav-link pageModal" data-target="${(tempModule.target)!}" >
