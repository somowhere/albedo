...
public class AlbedoBootWeb {

    private static final Logger log = LoggerFactory.getLogger(AlbedoBootWeb.class);
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(AlbedoBootWeb.class);
