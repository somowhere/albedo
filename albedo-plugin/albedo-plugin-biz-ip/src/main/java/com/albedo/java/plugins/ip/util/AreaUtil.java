...
public class AreaUtil {
	...
	private final static AreaUtil INSTANCE = new AreaUtil();
	...
	private AreaUtil() {
		...
		log.info("启动加载 AreaUtil 成功，耗时 ({}) 毫秒", System.currentTimeMillis() - now);
	}
	...
	public static <T> List<T> getByType(AreaTypeEnum type, Function<Area, T> func) {
		return CollUtil.convertList(areas.values(), func, area -> type.getType().equals(area.getType()));
	}
