<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption font-blue">
            <i class="fa fa-globe font-blue"></i><#if genScheme.id??>编辑<#else>添加</#if>生成方案
        </div>
		<div class="actions">
			<div class="btn-group">
                <a id="genScheme_list" class="btn red list" href="javascript:void(0);" data-table-id="#data-table-genScheme">
		...
		<form id="ajax_form" action="${ctx}/gen/genScheme/edit" method="post"
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" name="name" value="${(genScheme.name)! }"
				...
				<div class="form-group">
					...
					<div class="col-md-5"><@albedo.form name="category"
						...
						value="${(genScheme.category)! }"> </@albedo.form>
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input name="packageName" type="text" value="${(genScheme.packageName)! }"
							...
							class="help-inline">建议模块包：com.bosheng.modules.模块名</span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-5">
						...
						value="${(genScheme.viewType)! }"> </@albedo.form>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">生成模块名<span
						class="required">*</span></label>
					<div class="col-md-5">
						<input name="moduleName" type="text" value="${(genScheme.moduleName)! }"
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input name="subModuleName" type="text" value="${(genScheme.subModuleName)! }"
							htmlEscape="false" maxlength="64"
				...
				<div class="form-group">
					<label class="col-md-3 control-label">生成功能描述<span
						class="required">*</span></label>
					<div class="col-md-5">
						<input name="functionName" type="text" value="${(genScheme.functionName)! }"
							htmlEscape="false"
				...
				<div class="form-group">
					<label class="col-md-3 control-label">生成功能名<span
						class="required">*</span></label>
					<div class="col-md-5">
						<input name="functionNameSimple" type="text" value="${(genScheme.functionNameSimple)! }"
							htmlEscape="false"
				...
				<div class="form-group">
					<label class="col-md-3 control-label">生成功能作者<span
						class="required">*</span></label>
					<div class="col-md-5">
						<input name="functionAuthor" type="text" value="${(genScheme.functionAuthor)! }"
							htmlEscape="false"
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<label class="checkbox-inline"><input name="genCode" type="checkbox" value="true"  />是否生成代码</label>
					...
					<div class="col-md-2">
						<label class="checkbox-inline"><input id="syncModule" name="syncModule" value="true" type="checkbox"  />是否同步模块数据</label>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-5"><@albedo.form name="status"
						...
						value="${(genScheme.status)! }"> </@albedo.form></div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">描述</label>
					<div class="col-md-8">
						<textarea class="summernote form-control" name="description"
							rows="9">${(genScheme.description)! }</textarea>
					</div>
				</div>
