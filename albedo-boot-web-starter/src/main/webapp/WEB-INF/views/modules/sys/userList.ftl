        ...
        <div class="portlet-body">
        	<form class="form-inline form-search" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" searchItem="searchItem" id="email" name="email" placeholder="..."> 
                    </div>
                <div class="form-group">
            ...
            <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-user">
                <thead>
