            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" role="form">
						<div class="form-group">
							...
							<input type="text" class="form-control" searchItem="searchItem" id="loggerName" name="loggerName" value="${(loggingEvent.loggerName)!}" attrType="String" operation="eq" htmlEscape="false" maxlength="254" placeholder="...">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
                         ...
                         <button class="btn btn-sm green btn-outline filter-submit-table-loggingEvent margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-loggingEvent">
                        <thead>
        ...
        var initTradeOrderTable = function () {
            ...
            grid.init({
                ...
                dataTable: {
					...
					}, {data:'formattedMessage'}, {data:'arg0'
					}
					, {data:'arg1'
					}
					, {data:'arg2'
