    ...
    <div class="col-md-10">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <#if SecurityUtil.hasPermission('sys_dict_edit')><a id="add-dict" class="btn red dialog" href="javascript:void(0);" 
                        data-url="${ctx}/sys/dict/edit" data-modal-width="950" data-reload-after="refreshTreeDict" data-is-modal="true" data-table-id="#data-table-dict">
            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" dict="form">
                    ...
                    <button class="btn btn-sm green btn-outline filter-submit-table-dict margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
          ...
          <div id="bootstrap-alerts"></div>
                <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-dict">
                    <thead>
...
<script type="text/javascript">
                ...
                dataTable: {
                    ...
                    "columns": [
                        ...
                        { orderable: false, data: function ( row, type, val, meta ) {
                    		...
                    		<#if SecurityUtil.hasPermission('sys_dict_delete')>+'<a href="javascript:void(0);" class="confirm" data-table-id="#data-table-dict" data-reload-after="refreshTreeDict" data-method="delete" data-title="你确认要删除【'+row.name+'】字典吗？" data-url="${ctx}/sys/dict/delete/'+row.id+'"><i class=\"fa fa-lg fa-trash-o font-red-mint\" title=\"删除\"></i></a>'</#if>+'</span>';
                            return data;
                        }}
                    ]
                }
    ...
    var nodeId = albedo.getUserCookie("tree_dict_select_node_id"), nodeId = (nodeId)? nodeId : 1,addUrl = $("#add-dict").attr("data-url");
