package com.albedo.java.modules.sys.service.util;
...
public class JsonUtil {
	 ...
	 * @param list
	 * @param attributes
	 *            id,name 注意 属性前可跟前缀(re:)， 如 id|re:name 表示name从资源文件中加载
	 ...
	 * @param pm
	 * @param attributes
	 *            attributes id|name 注意 属性前可跟前缀(re:)， 如 id|re:name
	 *            表示name从资源文件中加载
	 * @return
	 */
