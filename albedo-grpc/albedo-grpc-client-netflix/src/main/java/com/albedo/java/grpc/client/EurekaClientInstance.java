 ...
 */
public class EurekaClientInstance {

    private static ApplicationInfoManager applicationInfoManager;
    private static DiscoveryClient eurekaClient;
    ...
    public synchronized DiscoveryClient initializeEurekaClient(ApplicationInfoManager applicationInfoManager, EurekaClientConfig clientConfig) {
    ...
    public void sendRequestToServiceUsingEureka(EurekaClient eurekaClient) {
        ...
        String vipAddress = "hcxd-mpns-rpc-server";
