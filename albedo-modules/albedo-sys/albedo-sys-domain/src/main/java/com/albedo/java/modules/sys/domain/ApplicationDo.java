...
@AllArgsConstructor
public class ApplicationDo extends IdDo<ApplicationDo, Long> {
	...
	@Builder
	public ApplicationDo(Long id, Long createdBy, LocalDateTime createdDate, Long lastModifiedBy, LocalDateTime lastModifiedDate,
