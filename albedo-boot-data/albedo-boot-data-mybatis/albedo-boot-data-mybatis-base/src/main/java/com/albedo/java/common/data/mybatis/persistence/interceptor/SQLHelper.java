...
//		}
     ...
     */
    public static int getFirstResult(PageModel<Object> page){
        int firstResult = (page.getPageNumber() - 1) * page.getPageSize();
        if (firstResult >= page.getRecordsTotal()) {
            firstResult = 0;
        }
        return firstResult;
    }
     ...
     * @return 分页SQL
     */
    public static String generatePageSql(String sql, PageModel<Object> page, Dialect dialect) {
        if (dialect.supportsLimit()) {
            return dialect.getLimitString(sql, getFirstResult(page), page.getPageSize());
        } else {
            return sql;
        }
    }
