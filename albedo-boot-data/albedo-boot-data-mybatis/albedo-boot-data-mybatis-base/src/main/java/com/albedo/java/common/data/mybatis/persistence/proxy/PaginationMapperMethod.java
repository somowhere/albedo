 ...
 */
package com.albedo.java.common.data.mybatis.persistence.proxy;

import com.albedo.java.common.data.mybatis.persistence.interceptor.SQLHelper;
...
public class PaginationMapperMethod {
    ...
    public Object execute(Object[] args) {
        ...
        PageModel<Object> page;
        RowBounds rowBounds;
        if (paginationIndex != null) {
            page = (PageModel<Object>) args[paginationIndex];
            rowBounds =  new RowBounds(SQLHelper.getFirstResult(page), page.getPageSize());
    ...
    private void setupMethodSignature() {
        ...
        for (int i = 0; i < argTypes.length; i++) {
            if (PageModel.class.isAssignableFrom(argTypes[i])) {
                paginationIndex = i;
