...
public class GenTable extends IdEntity {
	...
	@NotFound(action = NotFoundAction.IGNORE)@JSONField(serialize=false)
	...
	public String getNameAndComments() {
		if(PublicUtil.isEmpty(nameAndComments)) nameAndComments = getName() + (comments == null ? "" : "  :  " + comments);
