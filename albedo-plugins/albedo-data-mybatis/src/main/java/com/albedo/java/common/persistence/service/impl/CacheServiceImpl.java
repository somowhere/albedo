...
import com.albedo.java.common.persistence.service.CacheService;
 ...
 */
public abstract class CacheServiceImpl<Repository extends BaseRepository<T>, T> extends BaseServiceImpl<Repository, T> implements CacheService<T> {
