            ...
            <form id="ajax_form" action="${ctx}/sys/role/edit" method="post"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="name" value="${(role.name)! }" maxlength="64" data-required="1" class="form-control required" /> 
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group moduleIdList-div">
                        ...
                        <div class="col-md-2">
							<#list (role.moduleIdList)! as item><input id="moduleId" name="moduleIdList" type="hidden" value="${item}"/></#list>
							<div id="treeRoleModule" class="ztree"></div>
						</div>
						<label class="col-md-1 control-label treeRoleOrgBox hided">机构权限<span class="required">*</span></label>
                        <div class="col-md-3 treeRoleOrgBox hided">
							<#list (role.orgIdList)! as item><input id="orgId" name="orgIdList" type="hidden" value="${item}"/></#list>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                        <textarea class="summernote form-control" name="description" rows="5">${(role.description)! }</textarea>
                        </div>
                    </div>
...
var treeRoleModule,treeRoleOrg,data, setting = {view:{selectedMulti:false},check:{enable:true,nocheckInherit:true},
	...
	$(document).ready(function() {
		...
		// 刷新（显示/隐藏）机构
		refreshOrgTree();
		$("#dataScope").on("select2:select", function() { refreshOrgTree(); });
