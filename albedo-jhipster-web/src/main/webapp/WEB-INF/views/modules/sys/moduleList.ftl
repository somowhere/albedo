    ...
    <div class="col-md-10">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <#if SecurityUtil.hasPermission('sys_module_edit')><a id="add-module" class="btn red dialog" href="javascript:void(0);" 
                        data-url="${ctx}/sys/module/edit" data-modal-width="950" data-reload-after="refreshTreeModule" data-table-id="#data-table-module">
            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" module="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" searchItem="searchItem" id="name" name="name" placeholder="..."> </div>
                    <div class="form-group">
                        <label class="input-label" for="permission">权限 </label>
                        <input type="text" class="form-control" searchItem="searchItem" id="permission" name="permission" placeholder="..."> </div>
                    <div class="form-group">
                        <label class="input-label" >类型</label>
                        <@albedo.form name="type" searchItem="searchItem" dictCode="sys_module_type" boxType="checkbox" operate="in" attrType="Integer"> </@albedo.form></div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-sm green btn-outline filter-submit-table-module margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
          ...
          <div id="bootstrap-alerts"></div>
                <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-module">
                    <thead>
...
<script type="text/javascript">
                ...
                dataTable: {
                    ...
                    "columns": [
                        ...
                        { orderable: false, data: function ( row, type, val, meta ) {
                    		...
                    		<#if SecurityUtil.hasPermission('sys_module_delete')>+'<a href="javascript:void(0);" class="confirm" data-table-id="#data-table-module" data-method="delete" data-title="你确认要删除【'+row.name+'】模块吗？" data-reload-after="refreshTreeModule" data-url="${ctx}/sys/module/delete/'+row.id+'"><i class=\"fa fa-lg fa-trash-o font-red-mint\" title=\"删除\"></i></a>'</#if>+'</span>';
                            return data;
                        }}
                    ]
                }
    ...
    var nodeId = albedo.getUserCookie("tree_module_select_node_id"), nodeId = (nodeId)? nodeId : null,addUrl = $("#add-module").attr("data-url");
