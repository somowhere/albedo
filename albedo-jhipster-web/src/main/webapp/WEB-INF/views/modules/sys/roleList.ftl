    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <#if SecurityUtil.hasPermission('sys_role_edit')><a id="add_member" class="btn red dialog" href="javascript:void(0);" 
                        data-url="${ctx}/sys/role/edit" data-modal-width="950" data-no-modal="true" data-table-id="#data-table-role">
            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" role="form">
                       ...
                       <div class="form-group">
                           ...
                           <@albedo.form name="sysData" searchItem="searchItem" dictCode="sys_yes_no" boxType="checkbox" operate="in" attrType="Integer"> </@albedo.form></div>
                       <div class="form-group">
                       ...
                       <button class="btn btn-sm green btn-outline filter-submit-table-role margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
          ...
          <div id="bootstrap-alerts"></div>
                <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-role">
                    <thead>
                    <tr role="row" class="heading">
                        ...
                        <th width="10%"> 状态 </th>
                        <th width="20%"> 修改时间 </th>
                        <#if SecurityUtil.hasPermission('sys_role_edit,sys_role_lock,sys_role_delete')><th width="20%"> 操作 </th></#if>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            grid.init({
                ...
                dataTable: {
                    ...
                    "columns": [
                        ...
                        <#if SecurityUtil.hasPermission('sys_role_edit,sys_role_lock,sys_role_delete')> { orderable: false, data: function ( row, type, val, meta ) {
                    		...
                    		<#if SecurityUtil.hasPermission('sys_role_delete')>+'<a href="javascript:void(0);" class="confirm" data-table-id="#data-table-role" data-method="delete" data-title="你确认要删除【'+row.name+'】角色吗？" data-url="${ctx}/sys/role/delete/'+row.id+'"><i class=\"fa fa-lg fa-trash-o font-red-mint\" title=\"删除\"></i></a>'</#if>+'</span>';
                            return data;
                        }}</#if>
                    ]
                }
