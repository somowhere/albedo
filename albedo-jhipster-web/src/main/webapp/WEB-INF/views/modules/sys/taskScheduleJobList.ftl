    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <#if SecurityUtil.hasPermission('sys_taskScheduleJob_edit')><a class="btn red dialog" href="javascript:void(0);" 
                        data-url="${ctx}/sys/taskScheduleJob/edit" data-is-modal="" data-modal-width="950" data-table-id="#data-table-taskScheduleJob">
            ...
            <div class="portlet-body">
            	<form class="form-inline form-search" role="form">
						<div class="form-group">
							...
							<input type="text" class="form-control" searchItem="searchItem" id="name" name="name" value="${(taskScheduleJob.name)!}" attrType="String" operate="like" htmlEscape="false" maxlength="255" placeholder="...">
						</div>
                         <div class="form-group form-btn">
                         <button class="btn btn-sm green btn-outline filter-submit-table-taskScheduleJob margin-bottom" type="button"><i class="fa fa-search"></i> 查询</button>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer dt-responsive" id="data-table-taskScheduleJob">
                        <thead>
                        <tr role="row" class="heading">
                        	...
                        	<th class=""> 调用方法名 </th>
                        <#if SecurityUtil.hasPermission('sys_taskScheduleJob_edit,sys_taskScheduleJob_delete,sys_taskScheduleJob_lock')><th width="10%"> 操作 </th></#if>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
