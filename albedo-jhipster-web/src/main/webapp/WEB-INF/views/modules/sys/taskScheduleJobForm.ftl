<div class="portlet light bordered">
	<div class="portlet-title">
		...
		<div class="actions">
			<div class="btn-group">
                <a id="taskScheduleJob_list" class="btn red list" href="javascript:void(0);" data-table-id="#data-table-taskScheduleJob">
		...
		<form id="ajax_form" action="${ctx}/sys/taskScheduleJob/edit" method="post"
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control required" id="name" name="name" value="${(taskScheduleJob.name)!}" htmlEscape="false" maxlength="255">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">分组<span class="required">*</span></label>
					<div class="col-md-5">
						<input type="text" class="form-control required" id="group" name="group" value="${(taskScheduleJob.group)!}" htmlEscape="false" maxlength="255">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control " id="beanClass" name="beanClass" value="${(taskScheduleJob.beanClass)!}" htmlEscape="false" maxlength="255">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control " id="springId" name="springId" value="${(taskScheduleJob.springId)!}" htmlEscape="false" maxlength="255"">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control required" id="cronExpression" name="cronExpression" value="${(taskScheduleJob.cronExpression)!}" htmlEscape="false" maxlength="255">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control required" id="methodName" name="methodName" value="${(taskScheduleJob.methodName)!}" htmlEscape="false" maxlength="255">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">方法参数</label>
					<div class="col-md-5">
						<textarea class="form-control" name="methodParams" rows="5" maxlength="255" class="input-xxlarge ">${(taskScheduleJob.methodParams)! }</textarea>
						<label class="help-block">单个 {value:'test',attrType:'String',format:''} 多个加[]  json 语法</label>
						<label class="help-block">value 参数值 attrType 参数类型 Integer Long Short Float Double Date format当类型为Date 时有效</label>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">业务编号</label>
					<div class="col-md-5">
						<input type="text" class="form-control" id="sourceId" name="sourceId" value="${(taskScheduleJob.sourceId)!}" htmlEscape="false" maxlength="255">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">备注</label>
					<div class="col-md-5">
						<textarea class="form-control" name="description" rows="5" maxlength="255" class="input-xxlarge ">${(taskScheduleJob.description)! }</textarea>
					</div>
				</div>
				<div class="form-actions">
                   <div class="row">
                       <div class="col-md-offset-3 col-md-9">
                           ...
                           <button type="button" class="btn list" data-table-id="#data-table-taskScheduleJob">返回</button>
                       </div>
                   </div>
               </div>
			</div>
