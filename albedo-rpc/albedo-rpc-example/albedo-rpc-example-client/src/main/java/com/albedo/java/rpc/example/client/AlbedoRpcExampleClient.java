...
public class AlbedoRpcExampleClient {


    private static final Logger log = LoggerFactory.getLogger(AlbedoRpcExampleClient.class);
...
//        ConfigurableApplicationContext context = new SpringApplicationBuilder(AlbedoRpcExampleClient.class)
//                .registerShutdownHook(true)
//                .logStartupInfo(true)
//                .bannerMode(Banner.Mode.CONSOLE)
//                .run(args);
        SpringApplication app = new SpringApplication(AlbedoRpcExampleClient.class);
