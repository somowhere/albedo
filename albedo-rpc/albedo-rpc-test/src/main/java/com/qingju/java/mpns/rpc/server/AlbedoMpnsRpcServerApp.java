package com.qingju.java.mpns.rpc.server;
...
public class AlbedoMpnsRpcServerApp {


    private static final Logger log = LoggerFactory.getLogger(AlbedoMpnsRpcServerApp.class);
...
//        ConfigurableApplicationContext context = new SpringApplicationBuilder(AlbedoMpnsRpcServerApp.class)
//                .registerShutdownHook(true)
//                .logStartupInfo(true)
//                .bannerMode(Banner.Mode.CONSOLE)
//                .run(args);
        SpringApplication app = new SpringApplication(AlbedoMpnsRpcServerApp.class);
